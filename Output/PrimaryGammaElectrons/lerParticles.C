...
void lerParticles(){
	...
	double eMin = 0.;
	double eMax = 9000.;
	TH1D* hParticleEnergy = new TH1D("hParticleEnergy", "Electrons initial energy reconstruction for a "+strEnergy+"keV X-ray "+strGas, nBins, eMin, eMax);
	...
	for (int i = 0; i < n_events; i++) {
		...
		cout << "Energy: " << ei << "eV\n";
		cout << endl;*/
		hParticleEnergy->Fill(ei); //stored in keV
